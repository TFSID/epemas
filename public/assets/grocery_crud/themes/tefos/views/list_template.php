<?php
	$this->set_css($this->default_theme_path.'/tefos/css/flexigrid.css');
	$this->set_js_lib($this->default_javascript_path.'/' . \App\Libraries\GroceryCrud::JQUERY);

    $this->set_js_lib($this->default_javascript_path.'/common/list.js');

	$this->set_js($this->default_theme_path.'/tefos/js/cookies.js');
	$this->set_js($this->default_theme_path.'/tefos/js/flexigrid.js');

    $this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.form.min.js');

	$this->set_js($this->default_javascript_path.'/jquery_plugins/jquery.numeric.min.js');
	$this->set_js($this->default_theme_path.'/tefos/js/jquery.printElement.min.js');
...
<div class="flexigrid card row" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="col-12">
		<div class=" card-header pb-0">
			<h6>Tabel <?php echo $subject ?></h6>
		</div>
		<div title="<?php echo $this->l('minimize_maximize');?>" class="ptogtitle">
			<span></span>
		</div>
	</div>
	<div id='main-table-box' class="main-table-box card-body">
