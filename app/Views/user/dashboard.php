...
<html>
  ...
  <script defer="defer" src="js/main.js"></script><link href="css/styles.css" rel="stylesheet"><link href="css/style.css" rel="stylesheet">
      ...
      <div class="sidebar">
        <div class="sidebar-inner">
          ...
          <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item">
              <a class="sidebar-link" href="pengaduan">
                <span class="icon-holder">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="sidebar-link" href="tanggapan">Tanggapan</a>
                </li>
                <li>
